...
def run_test_count_cosines_from():
    ...
    # Test 2:
    answer_from_oracle = 1
    answer_from_my_code = count_cosines_from(1, 3, -0.2)
    print('Test 2 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)

    # Test 3:
    answer_from_oracle = 0
    answer_from_my_code = count_cosines_from(3, 9, 2)
    print('Test 3 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)

    # Test 4:
    answer_from_oracle = 7
    answer_from_my_code = count_cosines_from(3, 9, -1)
    print('Test 4 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)

    # Test 5:
    answer_from_oracle = 2
    answer_from_my_code = count_cosines_from(3, 9, 0.5)
    print('Test 5 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)

    # Test 6:
    answer_from_oracle = 3
    answer_from_my_code = count_cosines_from(3, 9, 0)
...
def run_test_sum_unit_fractions_from():
    ...
    # ------------------------------------------------------------------
    # Test 2:
    expected = 2.828968254  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 9)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 0.9956349206  # This is APPROXIMATELY the correct answer.
